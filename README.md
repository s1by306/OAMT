...
git clone https://github.com/mt4dl/ReIC/tree/release/REIC
... #run REIC from the step of https://github.com/mt4dl/ReIC/blob/release/REIC/README.md
python experiments/rq2/report_issues.py
...
### Discussion:Impact of cutting rates
Purpose: Investigate this effect of different cutting rate to integrity of test image and the numbers of total error detected
...
```bash
python experiments/cutting_rate/sample.py
python experiments/cutting_rate/cutting_rate_discussion.py
``` 